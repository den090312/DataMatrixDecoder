    ...
    public class Dmtx
    {
        ...
        public void DecodeSingle(Bitmap bitmap, DecodeOptions options, Barcode barcode, Context context, AppDomain domain)
        {
            ...
            DmtxDecode(
                ...
                {
                    var result = new DmtxDecoded { Data = new byte[dmtxDecodeResult.DataSize] };
        ...
        /// </code>
        /// </example>
        public DmtxEncoded Encode(byte[] data, EncodeOptions options)
        {
            IntPtr result;
            byte status;
            try
        ...
        public Bitmap PnmToBitmap(Stream pnmInputStream)
        {
            // read header
